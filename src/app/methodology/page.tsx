    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-8 text-slate-600 text-sm leading-relaxed">
        ...
        <section>
          ...
          <p>
            Every recall campaign, every VIN decode, and every owner complaint displayed on RecallScanner traces back
          ...
          <ul className="list-disc pl-5 space-y-1 mt-2">
            <li>
              <strong>NHTSA Recalls API:</strong> the recall campaign records you see on brand and model pages, including
              campaign numbers, affected model years, component categories, consequence language, and remedy instructions.
            </li>
            <li>
              <strong>NHTSA Complaints API:</strong> the owner-reported complaint counts shown on model pages, including
              crash, fire, injury, and death indicators flagged by the submitter.
            </li>
            <li>
              <strong>NHTSA VPIC (Vehicle Product Information Catalog) API:</strong> VIN decoding. When you enter a VIN, we
              pass it directly to VPIC to return make, model, year, engine, body class, drivetrain, and other decoded attributes.
            </li>
            <li>
              <strong>NHTSA VIN Recalls API:</strong> the live &quot;does this specific VIN have an open recall&quot; answer
